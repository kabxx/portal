...
@defineToolMetadata({
  ...
  description: [
    ...
    'Pass the task instructions in prompt. Optionally pass provider to choose chatgpt, claude, gemini, deepseek, doubao, grok, or glm; when omitted, the current provider is used.',
